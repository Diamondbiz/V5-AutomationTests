...
public class Connectivity_WiFi_Linear {
    ...
    // Define paths
    private static final String PROJECT_PATH = "/Users/hanangoverman/IntelliJProjects/V5-AutomationTests"; // Updated path
    ...
    public void runWifiConnectivityTest() {
        String deviceSerial = "GZ2407064N340046"; // Replace with your device serial number
